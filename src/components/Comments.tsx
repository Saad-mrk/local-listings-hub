...
const mockComments: Comment[] = [
  { id: "1", author: "Fatima Z.", rating: 5, text: "Vendeur très sérieux, produit conforme à la description. Livraison rapide !", date: "Il y a 2 jours" },
  { id: "2", author: "Youssef K.", rating: 4, text: "Bon état général, petit défaut non mentionné mais rien de grave. Je recommande.", date: "Il y a 1 semaine" },
  { id: "3", author: "Sara M.", rating: 5, text: "Excellente transaction, merci !", date: "Il y a 2 semaines" },
];
            ...
            <div className="flex items-center justify-between mb-1.5">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-secondary/20 flex items-center justify-center">
                  <span className="text-xs font-bold text-secondary-foreground">{comment.author[0]}</span>
                </div>
