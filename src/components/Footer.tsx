    ...
    <footer className="bg-background/50 backdrop-blur border-t border-secondary/20">
      ...
      <div className="container py-12">
        ...
        >
          ...
          <motion.div className="lg:col-span-1" variants={itemVariants}>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              La plateforme de confiance pour acheter et vendre au Maroc
            </p>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Recevez les meilleures annonces directement dans votre boîte mail
          </p>
        ...
        >
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} LBAL. Tous droits réservés.
          </p>
      ...
      >
        Fait avec <Heart className="h-3 w-3 inline fill-red-500 text-red-500" />{" "}
        au Maroc
      </motion.div>
    </footer>
  );
